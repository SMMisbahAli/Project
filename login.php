						...
						<div class="kt-login__body">
							...
							<div class="kt-login__form">
								...
								<form class="kt-form" action="" method="post"  id="kt_login_form" >
									...
									<p class="alert alert-info">Code has been sent to your email</p>
										
										<div class="form-group  mb-3">
											<label for="inputEmail4">Enter Verification code</label>
											<input type="text" class="form-control" name="code" placeholder="Login code ">
										</div>
									...
									<div class="kt-login__actions">
									    ...
									    <?if($g_forgetPasswordEnabled){?>
										<a href="./forget_password.php" class="kt-link kt-login__link-forgot">
											Forgot Password ?
										</a>
										<?}?>
										<!--<a href="./signup.php" class="kt-link kt-login__link-forgot">
											Create new account
										</a>-->
										...
										<input type="submit" value="Log In" name="login" id="kt_login_signin_submit" class="btn btn-primary btn-elevate kt-login__btn-primary w-100" >
									</div>
